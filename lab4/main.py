...
if __name__ == '__main__':
    ...
    ds_train = MNISTMetricDataset(mnist_download_root, split='train', remove_class=DROP)
    ...
    if not IDENTITY_MODEL and SAVE_WEIGHTS:
        os.makedirs('./weights', exist_ok=True)
        pattern = re.compile(rf'model_(\d+)\.pt')
        ...
        torch.save(model.state_dict(), f'./weights/model_{next_index}.pt')
